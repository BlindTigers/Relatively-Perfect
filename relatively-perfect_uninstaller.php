 ...
 * @author Tom Klingenberg
 */
abstract class btrp_uninstaller_abstract {
 ...
 * @author Tom Klingenberg
 */
class btrp_uninstaller extends bcn_uninstaller_abstract {
	 ...
	 * @var string plugin dirname
	 */
	protected $_base = 'relatively-perfect';
